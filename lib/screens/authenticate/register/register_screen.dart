              ...
              child: Column(
                ...
                children: <Widget>[
                  AppFormField(
                    ...
                    onChange: (val){
                      BlocProvider.of<RegisterFormBloc>(context).add(NameChangeEvent(name: RegisterFormBlocModel(value: val!)));
                    },
                    validator: (val) {
                  ...
                  AppFormField(
                    hintText: "Email",
                    onChange: (val){
                      BlocProvider.of<RegisterFormBloc>(context).add(EmailChangeEvent(email: RegisterFormBlocModel(value: val!)));
                    },
                    validator: (val) {
                  ...
                  AppFormField(
                    hintText: "Password",
                    onChange: (val){
                      BlocProvider.of<RegisterFormBloc>(context).add(PasswordChangeEvent(password: RegisterFormBlocModel(value: val!)));
                    },
                    validator: (val) {
                  ...
                  Row(
                    children: [
                      ElevatedButton(onPressed: (){
                        BlocProvider.of<RegisterFormBloc>(context).add(FormSubmitEvent());
                      }, child: const Text(AppStrings.submitStr)),
                      ElevatedButton(onPressed: (){
                        BlocProvider.of<RegisterFormBloc>(context).add(FormResetEvent());
